(function ($) {
    $.fn.tmTip = function (options) {
        ...
        function tipInit($this, opts) {
            ...
            if (opts.width != 0) {
                $(".tm-window-tip").css({width: opts.width});
            }/*设置高度如果高度设置为0：则为自动高度*/
            if (opts.height != 0) {
                $(".tm-window-tip").css({height: opts.height});
            }/*设置高度如果高度设置为0：则为自动高度*/
...
$.tzDialog.methods = {
    ...
    params: function ($dialog, opts) {
        ...
        $dialog.find(".tzdialog_message").css({
            "textAlign": "center",
            "lineHeight": opts.height - 170 + "px"
